...
- **[organize-disk](./organize-disk/SKILL.md)** — Drive the DiskButler tool to search, analyse, and safely tidy local drives: fast file search, junk/duplicate cleanup via reversible quarantine, and Windows leftover/autostart hygiene.
